...
urlpatterns = [
    ...
    path('editar-chacara/novo-residente/', views.novo_visitante, name='novo residente'),
    path('editar-chacara/<int:page>/', views.EditarChacara.as_view(), name='editar chacara'),
