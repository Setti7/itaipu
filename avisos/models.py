...
class Aviso(models.Model):
    ...
    autor = models.ForeignKey(Residente, on_delete=models.PROTECT, related_name='avisos_autor')
    titulo = models.CharField(max_length=100, verbose_name='título')
    subtitulo = models.CharField(max_length=200, verbose_name='subtítulo', null=True, blank=True)
    editado_por = models.ForeignKey(Residente, on_delete=models.CASCADE, null=True, related_name='avisos_editado_por')

    viewers = models.ManyToManyField(Residente, through='AvisoViewer', related_name='avisos_viewers')
...
class AvisoViewer(models.Model):
    ...
    data_visualizado = models.DateTimeField(null=True, blank=True,
                                            help_text='Esse campo é populado quando o usuário clica em "Ler mais" no aviso.')
